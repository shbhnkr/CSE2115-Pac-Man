...
public class PowerPelletTest {
    ...
    public void gallbossCollisionLeft() {
        ...
        Game game = new Game(new Gamesettings(20, null), "poweredPelletTest.txt");
    ...
    public void beerCollisionLeft() {
        ...
        Game game = new Game(new Gamesettings(20, null), "beerTest.txt");
        Player player = game.player;
        player.moveLeft(game, game.getWidth());
    ...
    public void fruitCollisionLeft() {
        ...
        Game game = new Game(new Gamesettings(20, null), "fruitTest.txt");
        Player player = game.player;
        int n = game.point;
        player.moveLeft(game, game.getWidth());
